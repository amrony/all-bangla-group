                ...
                <div class="row justify-content-lg-start justify-content-center">
                    <div class="col-xl-6 col-sm-12 col-12 col-lg-6">
                        <h3 class="text-capitalize wow fadeInLeft" data-wow-delay=".2s">Login to<span
                                    class="text-primary"> Business</span></h3>
                        <form class="rd-mailform text-left home-form" data-form-output="form-output-global" data-form-type="contact">
                            ...
                            <div class="form-wrap">
                                <label class="form-label" for="password">Password<span class="req-symbol">*</span></label>
                                <input class="form-input" id="password" type="password" name="password" data-constraints="@Required @PhoneNumber">
                            </div>
                            <div class="form-button group-sm text-center text-lg-left">
                                <button class="button button-primary button-circle button-lg" type="submit">Login</button>
                            </div>
                        </form>
                    </div>
                </div>
