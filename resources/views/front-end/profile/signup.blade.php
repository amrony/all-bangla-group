                ...
                <div class="row justify-content-lg-start justify-content-center">
                    <div class="col-xl-6 col-sm-12 col-12 col-lg-6">
                        ...
                        <form class="rd-mailform text-left home-form" data-form-output="form-output-global" data-form-type="contact">
                            <div class="form-wrap">
                                <label class="form-label" for="first-name">First Name<span class="req-symbol">*</span></label>
                                <input class="form-input " id="first-name" type="text" name="first_name" data-constraints="@Required @Name">
                            </div>
                            <div class="form-wrap">
                                <label class="form-label" for="last-name">Last Name<span class="req-symbol">*</span></label>
                                <input class="form-input " id="last-name" type="email" name="last_name" data-constraints="@Required @Name">
                            </div>
                            <div class="form-wrap">
                            ...
                            <div class="form-wrap">
                                <!--                                <label class="form-label" for="contact-email">Country<span class="req-symbol">*</span></label>-->
                                <select class="form-input">
                                    <option class="form-label">Please Choose Country<span class="req-symbol">*</span></option>
                            ...
                            <div class="form-wrap">
                                <label class="form-label" for="password">Create Password<span class="req-symbol">*</span></label>
                                <input class="form-input" id="password" type="password" name="password" data-constraints="@Required @PhoneNumber">
                            </div>
                            <div class="form-wrap">
                                <label class="form-label" for="conformation_password">Confirm Password<span class="req-symbol">*</span></label>
                                <input class="form-input" id="conformation_password" type="password" name="conformation_password" data-constraints="@Required @PhoneNumber">
                            </div>
